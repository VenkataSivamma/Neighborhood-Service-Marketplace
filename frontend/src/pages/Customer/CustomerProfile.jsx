...
export default function CustomerProfile() {
  ...
  const [form, setForm] = useState({ fullName: "", email: "", phoneNumber: "", city: "" });
  ...
  const handlePasswordSave = async (e) => {
    ...
    setSaving(true);
    try {
      await updateCustomer(uid, { ...form, password: passwordForm.newPassword });
